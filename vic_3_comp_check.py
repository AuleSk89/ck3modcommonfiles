...
# Set up directories
project_dir = r'C:\oned\OneDrive\python projects\240720 - vic3 mod incompatibility'
...
# Load JSON data
json_file_path = r'C:\oned\OneDrive\python projects\240720 - vic3 mod incompatibility\1.7.5_20240721_SK2.json'
with open(json_file_path, 'r') as file:
    data = json.load(file)
logging.info(f'Loaded JSON file from {json_file_path}.')

mods = data['mods']
base_path = 'D:/SteamLibrary/steamapps/workshop/content/529340'
...
shutil.copy(script_filename, os.path.join(code_dir, f'vic_3_comp_check_{timestamp}.py'))
logging.info(f'Script copied to {os.path.join(code_dir, f"vic_3_comp_check_{timestamp}.py")}.')
